...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // This is where you would integrate your authentication logic
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <User size={48} weight="fill" className="text-emerald-500 "/>

          <h2 className="mt-4   text-center text-3xl font-extrabold text-gray-900">Dashboard Absensi</h2>
        </div>
