...
const Karyawan: React.FC = () => {
    ...
    // Jika tidak ada `name`, hentikan eksekusi fungsi
    if (!name) return;
                ...
                <div className="">
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button
                                className="bg-slate-100 border border-emerald-500 shadow-sm text-emerald-500 hover:bg-emerald-100 cursor-pointer flex items-center gap-2"
                            >
        ...
        {/* Table list karyawan */}
            <section className="bg-white rounded-lg border space-y-2 py-2">
                ...
                <Table className="bg-white">
                    ...
                    <TableBody>
                        {data.map((item) => (
                            <TableRow className="border-y" key={item.id}>
